...
visual('spawn multiple entities', ({ spatial }) => {
...
visual('entity moves in a square', ({ spatial }) => {
...
visual('projectile hits enemy', ({ spatial }) => {
...
visual('multiple layers at same cell', ({ spatial }) => {
