...
export class InputManager {
    ...
    private updateStateFromEvents(): void {
        ...
        this.state.action = this.keysDown.has(' ') || this.actionKeyPressed || this.actionBuffer;
     ...
     * ```
     */
    injectInput(direction: Direction = Direction.NONE, action: boolean = false, secondary: boolean = false): void {
