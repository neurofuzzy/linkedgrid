...
export class KeyboardInputManager {
  ...
  private getDirection(): Direction {
    ...
    // WASD fallback
    if (this.keysThisFrame.has('w') || this.keysThisFrame.has('W')) return Direction.UP;
    if (this.keysThisFrame.has('s') || this.keysThisFrame.has('S')) return Direction.DN;
    if (this.keysThisFrame.has('a') || this.keysThisFrame.has('A')) return Direction.LT;
    if (this.keysThisFrame.has('d') || this.keysThisFrame.has('D')) return Direction.RT;
  ...
  private getDirectionFromKey(key: string): Direction {
    switch (key) {
      ...
      case 'ArrowDown': case 's': case 'S': return Direction.DN;
      case 'ArrowLeft': case 'a': case 'A': return Direction.LT;
      case 'ArrowRight': case 'd': case 'D': return Direction.RT;
